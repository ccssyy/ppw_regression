...
def training(batch_size=256, lr=0.0001, kprob=0.8):
    dir_path = 'VGG16-16-32-64-128-128-1024-k-3-p-2-lr-' + str(
        lr) + '_regularization-05_random-5_correct_in_segment_loss_v39'
    ...
    train_X = load_data.get_trainset('train_set_v8_random_5.h5', 'ppw1').reshape([-1, 1, 500, 1])
    ...
    test_X = load_data.get_testset('test_set_v8_random_5.h5', 'ppw1').reshape([-1, 1, 500, 1])
